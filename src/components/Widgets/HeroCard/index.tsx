...
const HeroCard = ()=> {
    return (
        <div className='flex p-[12px] flex-col items-center flex-[1_0_0]  rounded-3xl border-[1px] border-[#292C31] bg-[#292C31] w-[229px] box-border'>
            ...
            <div className='flex justify-between w-full my-[12px]'>
                ...
                <div className='font-["Lato"] text-[14px] not-italic text-[#E5E1A8] leading-[20px] flex items-center'><div className='h-[14px] w-[14px] rounded-full bg-[#676A71]/[.3] flex justify-center items-center mr-3'><img src="assets/img/Sol.png" alt="" className='w-[9px] h-[9px]' /></div> 11.89 SOL</div>
            </div>
